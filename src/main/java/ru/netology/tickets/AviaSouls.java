...
public class AviaSouls {
    ...
    public Ticket[] search(String from, String to) {
        ...
        Arrays.sort(result); // Сортировка масива по возрастанию цены
        return result;
    }

    TicketTimeComparator comparator = new TicketTimeComparator(); // создаём объект компоратора
    ...
    public Ticket[] searchAndSortBy(String from, String to, Comparator<Ticket> comparator) {
        ...
        Arrays.sort(result, comparator); // Сортировка массива по возрастанию продолжительности полёта
        return result;
    }
}
